      ...
      <div id="bookingOptions">
        ...
        <div class="event-info">
            ...
            <div class="info artists">
              <h3><span>TENT <b>//</b> </span>CHRIS COCO, SARAHTONIN  <p>[09PM - 04AM]</p></h3>
              <h3><span>STUDIO <b>//</b> </span>LUTHER VINE, RALPH LAWSON, RHYTHMS OF PRESCOTT, SAM LUKE  <p>[10PM - 5AM]</p></h3>
            </div>
        </div>
        <div class="book-wrapper">
          ...
          <div class="button-wrapper new-button-wrapper">
            <Button classes="events-button new-events-button"  btnType="hollow">
              <a href="https://www.sevenrooms.com/reservations/littleportland?default_date=2025-05-10&default_time=21:00&default_party_size=4" target="_blank">
        ...
        <div class="button-wrapper new-button-wrapper">
            ...
            <a href="https://sevn.ly/xgsMDRy2" target="_blank">
                CLUB TICKETS ONLY
              </a>
            </Button>
        </div>
