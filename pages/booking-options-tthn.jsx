  ...
  return (
    <>
      ...
      <div id="bookingOptions">
        <h1 className="event-name desktop-only day-category">Utopia<span className="day">Presents</span></h1>
        
        <h1 className="event-name mobile-only cat">Utopia<span className="cat-day">Presents</span></h1>

        <div className="event-info">
            <div class="info date">
              <h2><span>SAT</span>26 Jul</h2>
            </div>
            <div class="info artists">
              <h3><span>TENT <b>//</b> </span>Harry Flowers, KC HAPPY, Robert Outch</h3>
              <h3><span>STUDIO <b>//</b> </span>ALEX From UTOPIA, TECH SUPPORT</h3>
            </div>
        </div>
        ...
        <div className="book-wrapper">
         ...
         <div class="button-wrapper new-button-wrapper desktop-only">
            <Button classes="events-button new-events-button"  btnType="hollow">
              <a href="https://www.sevenrooms.com/reservations/littleportland?default_date=2025-07-26&default_time=21:00&default_party_size=4" target="_blank">
