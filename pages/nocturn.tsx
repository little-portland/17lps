    ...
    <>
      <Head>
        <style>
            ...
            {'@media (max-width: 768px) { .nocturn{width: 90%;margin: 0 auto 15px auto;}.nocturn-wider-section .flyer:hover{filter: none!important;}.subscribe{width: 100%!important;}.subscribe .bookings-iframe{width: 85%!important;height: 100% !important;}.row{padding: 0!important;text-align: center!important;}.column{ flex: 50%;max-width: 50%;}}'}
         </style>
