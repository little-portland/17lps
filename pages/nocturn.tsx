    ...
    <>
      <Head>
        <style>
            ...
            {'@media (max-width: 768px) { .nocturn{width: 90%;margin: 0 auto 15px auto;}.subscribe {width: 100%!important;}.subscribe .bookings-iframe{width: 100%!important;height: 100% !important;}.subscribe h2{padding-left: 20px;text-align:left;margin-bottom: -50px;}.nocturn-text-wrapper{padding: 0 15px;text-align: center!important;margin-bottom: 20px;}.nocturn-text-wrapper .nocturn-text:{padding-left: 5px;}.nocturn-wider-section{width: 90%;}.nocturn-wider-section p{ font-size: 20px;}.bottom{ margin-top: 10px!important;}.bottom p{ font-size: 15px;}.row{padding: 0!important;text-align: center!important;}.column{ flex: 50%;max-width: 50%;}}'}
        </style>
        <title>Nocturn</title>
      </Head>
