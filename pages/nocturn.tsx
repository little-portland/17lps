    ...
    <>
      <Head>
        <style>
            ...
            {'@media (max-width: 768px) { .nocturn{width: 90%;margin: 0 auto 15px auto;}.subscribe .bookings-iframe{width: 100%!important;height: 100% !important;}.nocturn-text-wrapper{padding: 0 15px;text-align: center!important;margin-bottom: 20px;}.nocturn-wider-section{width: 90%;}.nocturn-wider-section p{ font-size: 20px;}.bottom{ margin-top: 10px!important;text-align: center!important;}.bottom p{ font-size: 15px;}.row{padding: 0!important;}.column{ flex: 50%;max-width: 50%;}}'}
        </style>
        <title>Nocturn</title>
      </Head>
