    ...
    <>
      <Head>
        <style>
            ...
            {'.subscribe .bookings-iframe{width: 30%!important;height: 30% !important;display: block;place-items: center;margin: 0 auto;min-height: 30rem!important;}'}
            {'.row{ display: flex;flex-wrap: wrap;padding: 0 4px;}'}
            {'.column{flex: 33%;max-width: 33%;padding: 0 4px;}'}
            {'.subscribe .column{flex: 100%;max-width: 100%;padding: 0 4px;}'}
            {'.column img{ margin-top: 8px;vertical-align: middle;width: 100%;}'}
            {'.column a{ cursor:pointer!important;}'}
            {'.text-input-field{border-top: 0!important;border-left: 0!important;border-right: 0!important;padding: 0!important;border-width: 1px!important;font-size: 13px!important;}'}
            {'.top{ font-size: 18px;}'}
