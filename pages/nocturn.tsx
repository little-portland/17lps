    ...
    <>
      <Head>
        <style>
            ...
            {'@media (max-width: 768px) { .nocturn{width: 90%;margin: 0 auto 15px auto;}.subscribe .bookings-iframe{width: 100%!important;height: 100% !important;}.nocturn-wider-section{width: 90%;}.nocturn-wider-section{width: 90%;}.top{ font-size: 20px;}.bottom{ font-size: 15px;margin-top: 10px !important;}.row{padding: 0!important;}.column{ flex: 50%;max-width: 50%;}}'}
