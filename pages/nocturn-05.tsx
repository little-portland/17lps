    ...
    <>
      <Head>
        <style>
            ...
            {'.column img {margin-top: 8px;vertical-align: middle;width: 100%;border: 5px solid #000;outline: 2px solid #fff;outline-offset: 0;display: inline-block;animation: jitter 120ms infinite steps(2, end);}'}
            {'@keyframes jitter {0% { transform: translate(0,0) rotate(0deg); } 50%  { transform: translate(0.5px,-0.5px) rotate(-0.15deg); }100% { transform: translate(-0.5px,0.5px) rotate(0.15deg); }}'}  
