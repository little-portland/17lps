    ...
    <>
      <Head>
        <style>
            ...
            {'.col img::after {content: "";position: absolute;top: -7px; left: -7px; right: -7px; bottom: -7px;border: 3px solid #fff;border-radius: 4px;pointer-events: none;animation: jitterBorder 180ms infinite steps(2, end);}'}  
