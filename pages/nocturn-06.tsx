    ...
    <>
      <Head>
        <style>
            ...
            {'.gallery-text p{margin-top: 15px;margin-bottom: 25px; text-align: center;}'}
            {'.gallery-text{ font-family: Helvetica!important;font-size: 25px;font-style: italic; color: #660003!important;text-shadow: 1px 1px 1px rgba(171, 209, 227, 0.6);font-weight: 400;text-decoration: none!important;padding-bottom: 30px;line-height: 1.1;}'}  
           ...
           <div className="nocturn-text-wrapper top">
            ...
            <div className="inner-content bottom">
              <p>
                ...
                Absence. Division. Rupture.<br />
                But what is the third thing?</p>
                 
                <p>That thing I will never be able to name.<br />
                I desire you, but I desire my sovereignty more. Somewhere in-between there lies the riddle of Sphinx I’ll never solve. Will we touch? Will I surrender? Together, a dance unfolds. Some days we are made, other days I am unmade and re-made. What contours the shape of the thing itself?</p>
                ...
                How do I shed what I no longer need to carry? The lifeless skins of old versions of myself, no longer animated, no longer necessary… The rawness of fresh scales undulating underneath, waiting to be seen. Where does your skin begin and mine end?</p>
                ...
                <p>In the dark of night when I wake to see what all those souls are doing down there, I feel their watery bodies and the bodies of water that surround them.</p>
               ...
               <p> The fever of my curiosity never lessens even as I watch with dispassionate observation at the randomness of the order of the cosmos and sometimes, I am pensive: why do I get to witness you? Will you ever remember that we were at one time and still made of the same primordial dust, like the ones you forget to clean off your window sill?<br />
                Seething with anger I smash the window into broken shards. The space and my mirrored body undergo a kind of disintegration, a collapse into a chaotic state.</p>
                ...
                <p>And another portal opens… another layer of reality, a new dimension which is an ancient one too. I am you and you are me. We are free.</p>
                 
                <p>I am going in, diving into the sticky hot mess that is both random and written. The inner reaches of outer space, let’s keep this pace?</p>
                 
                <p>There my desires have many faces and many voices and many chances to express, without limitation, without fear…</p>
                 
                <p>Deep into the Earth we go, traipsing and trawling all over the ground, what will be found?<br />
                Find the trap door into the hidden ocean. That deep reservoir of crystalline waters 400 miles under the earth’s mantle.</p>
                
                <p>Crawl under my skin like a seismic wave. We are all bodies of water longing to return to the source.</p>
                ...
                <p>I long to return to the source, but what is our source? From where does this vital energy flow?</p>
                ...
                Allow the body to sink deeper and deeper into that lightless trench of sleep.<br />
                When you’re so exhausted that even your astral body quits its side quests.<br />
                With your hands and feet bound, your eyes closed, a new kind of motion begins.<br />
                A doing not doing.</p>
                 
                <p>You see a rocky island rising vertically from still, dark water. At the base of the cliff, sheltered by tall, dense trees is a rectangular opening cut into the rock. Legend has it that this island is a sleeping dragon, coiled like a snake. Will you awaken the dragon?</p>
                 
                <p>If you spend long enough in the doorway<br />
                it becomes a tunnel.<br />
                Are you willing to step through?</p>
                 
                <p>The courage it takes to take that step through, I muster it. I gather it all, I summon it to me, I call out and I hear the wings of a falcon but I do not see her with my eyes. The silence is music to my ears.</p>
                ...
                The earth below me pulses, I feel the dragon’s breath and I wait. I wait and I wait. </p>
                ...
                <p>Without a shadow of a doubt, without a moment’s hesitation, I leap from the edge and my arms cast themselves wide, outstretched to each side, and she catches me on each shoulder.</p>
                ...
                <p>We dive into the rock crater and the heat of its insides ignites me too.</p>
                 
                <p>I am a falcon making love to a dragon, what will we make anew?</p>
                ...
                <p>A softness envelops a sharp thought. Inside this chamber of micro-bubbles I feel myself reorganising. Each bubble is a catalyst for new growth. Every seed is a small death. Bonds loosen.</p>
                ...
                <p>Two beating hearts, they play: one swallowed by another, another inside other, foreign and family, a wave cascading over another wave, their crests touch again – and again a heightened, luscious sensation ripples across the entire vibrating world.</p>
                 
                <p>What is this world? Where do I begin and end? What power seeps inside, what power dies outside?</p>
               ...
               <p> Why does your mouth taste bitter?<br />
                ...
                <p>Sensation is an ever-changing field, they said, a moveable feast.<br />
                Wait a moment and the mood shifts and melds into others. Take a breath and the atmosphere sings a different scent. Close your eyes and listen to the different rhythms.</p>
                ...
                <p>The illusion begins to dissolve, and I remember thatness which is you and I. We.<br />
