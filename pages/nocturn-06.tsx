    ...
    <>
      <Head>
        <style>
            ...
            {'body{background-color: #b94b18;overflow: auto!important;overflow-x: initial!important;}'}
            ...
            {'@media (max-width: 768px) { .row{padding: 0!important;}.column{ flex: 50%;max-width: 50%;}}'}
