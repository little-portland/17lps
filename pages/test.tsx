        ...
        <div className="eat-note dance-popup">
          <div>
            ...
            <div className="category">
              <h3>Thursday <span className="is">is</span> <span className="group">Underground</span></h3>
            ...
            <div className="category">
              <h3>Friday <span className="is">is</span> <span className="group">Residents</span><</h3>
            ...
            <div className="category">
              <h3>Saturday <span className="is">is</span> <span className="group">Disco3000</span><</h3>
