    ...
    <>
      ...
      <div id="bookingOptions">
        ...
        <div class="event-info">
            <div class="info date">
              <h2><span>FRI</span>17 May</h2>
            </div>
            <div class="info artists">
              <h3><span>STUDIO <b>//</b> </span>BAS IBELLINI & FRIENDS</h3>
              <h3><span>TENT <b>//</b> </span>FREDERIKA, JUNGLE JARVIN </h3>
            </div>
        </div>
        <div class="button-wrapper new-button-wrapper">
            <Button classes="events-button new-events-button"  btnType="hollow">
              <a href="https://www.sevenrooms.com/reservations/littleportland?client_id=726461756e9725a88ff001a4cae308fd0b5020c074f3e2a8324b11b92c890e1a9154f6d75f5af47a4328f2d005c03c4682b66fe2bcf82664bcbb340e918684fa&default_date=2024-05-17" target="_blank">
        ...
        <div class="button-wrapper new-button-wrapper">
            <Button classes="events-button ticketNew" btnType="hollow">
              <a href="https://sevn.ly/x20Jbguj" target="_blank">
                CLUB GUESTLIST ONLY
              </a>
            </Button>
        </div>
