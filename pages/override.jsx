    ...
    <>
      <Head>
        <style>
            ...
            {`.spacing{ margin-top:30px!important;}`}
            {`.slideshow-wrapper{ max-width: 70%; margin: 0 auto;}`}
