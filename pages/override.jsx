        ...
        <div class="button-wrapper new-button-wrapper">
            <Button classes="events-button ticketNew override-btn" btnType="hollow" >
              <a href="https://sevn.ly/xeLHgzuf" target="_blank">
                ...
                <span class="takeover-date">28 Nov<span class="takeover-time">From 7PM</span></span>
              </a>
            </Button>
        </div>
        ...
        <div class="button-wrapper new-button-wrapper">
            <Button classes="events-button ticketNew override-btn" btnType="hollow">
              <a href="https://sevn.ly/x67GScdC" target="_blank">
                ...
                <span class="takeover-date">11 Dec<span class="takeover-time">From 7PM</span></span>
              </a>
            </Button>
        </div>
       ...
       <div class="button-wrapper new-button-wrapper">
            <Button classes="events-button ticketNew override-btn" btnType="hollow">
              <a href="https://sevn.ly/xMWA7DA6" target="_blank">
                SEB MEYERS <span class="rest-name">(PLanque)</span>
                <span class="takeover-date">29 Jan<span class="takeover-time">From 7PM</span></span>
              </a>
            </Button>
        </div>
         <div>
