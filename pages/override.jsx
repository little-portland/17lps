    ...
    <>
      <Head>
        <style>
            ...
            {'.override-page h3{ font-family: Oswald!important;font-weight: bold!important;text-decoration: none!important;color: #d5ccc0!important;padding-bottom: 30px;line-height: 1.1;font-size:4rem!important;}'}
            ...
            {'.override-page button{transition: all .25s ease-in-out!important; -moz-transition: all .25s ease-in-out!important; -webkit-transition: all .25s ease-in-out!important;}'}
            {'.override-page button:hover{background: #d5ccc0!important;}'}
            {'.override-page span{display: block!important;margin-top: 15px;}'}
            {'@media (max-width: 768px) { #override-page{ width: 300px;top: 2%!important;}.override-page button{margin-top:10px!important;}.override-page h3 { font-size: 3rem!important;padding-bottom: 20px!important;margin-top: -10px!important;}.override-page a {padding: 5px 10px!important;}}'}
        </style>
