      ...
      <Head>
        ...
        <style>
            ...
            @keyframes flicker {
                ...
                50%      { filter: drop-shadow(0 0 20px rgba(0,100,255,1)) drop-shadow(0 0 20px rgba(0,255,120,0.9)); }
              }
        ...
        <title>17 Little Portland Street - Studio</title>
         ...
         <div className="nocturn override">
           ...
           <div className="override-buttons-wrapper">
             <a target="_blank" href="/images/studio/acoustic-test-report.pdf" class="override-button hollow-btn">View Acoustic Test Report</a>
          </div>
         </div>
        ...
        <div className="nocturn-wider-section override">
