  ...
  return (
    <>
      ...
      <div id="bookingOptions">
        <h1 className="event-name desktop-only day-category">Openlab<span className="day">Presents</span></h1>
        
        <h1 className="event-name mobile-only cat">Openlab<span className="cat-day">Presents</span></h1>

        <div className="event-info">
            <div class="info date">
              <h2><span>SAT</span>02 Aug</h2>
            </div>
            <div class="info artists">
              <h3><span>TENT <b>//</b> </span>RALPH LAWSON, RICHARD MARSHALL, TINTIN </h3>
        ...
        <div className="button-wrapper new-button-wrapper mobile-only">
          <Button classes="events-button ticketNew" btnType="hollow">
            <a href="https://sevn.ly/xv9PKVzX" target="_blank">
        ...
        <div className="book-wrapper">
         ...
         <div class="button-wrapper new-button-wrapper desktop-only">
            <Button classes="events-button new-events-button"  btnType="hollow">
              <a href="https://www.sevenrooms.com/reservations/littleportland?default_date=2025-08-02&default_time=21:00&default_party_size=4" target="_blank">
