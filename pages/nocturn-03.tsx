    ...
    <>
      <Head>
        <style>
            ...
            {'@media (max-width: 768px) {.spacing{ margin-top:15px!important;}.preloader{ margin:15px 0 -15px 0!important;}.loading{ font-size: 35px;}.live{ border-top: 3px solid #000;padding-top: 20px;border-bottom: 3px solid #000;margin-bottom: 30px}.nocturn-text-wrapper{padding: 0 15px;}.top{ font-size: 20px;}.bottom{ font-size: 15px;}.nocturn-text-wrapper small{ font-size: 12px!important;margin-left: 5px!important;}.row{padding: 0!important;}}'}
        </style>
