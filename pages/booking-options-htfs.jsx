      ...
      <div id="bookingOptions">
        ...
        <div class="event-info">
            ...
            <div class="info artists">
              <h3><span>TENT <b>//</b> </span>Georgi㋛OOOOOOOO, Kristina May</h3>
        ...
        <div class="button-wrapper new-button-wrapper">
            ...
            <a href="https://www.sevenrooms.com/reservations/littleportland?client_id=726461756e9725a88ff001a4cae308fd0b5020c074f3e2a8324b11b92c890e1a9154f6d75f5af47a4328f2d005c03c4682b66fe2bcf82664bcbb340e918684fa&default_date=2025-01-30" target="_blank">
        ...
        <div class="button-wrapper new-button-wrapper">
            ...
            <a href="https://sevn.ly/xCrRmwgI" target="_blank">
                CLUB TICKETS ONLY
              </a>
            </Button>
        </div>
