  ...
  return (
    <>
      ...
      <div id="bookingOptions">
        <h1 className="event-name desktop-only day-category disco-saturdays">Balearic London<span className="day">Presents</span></h1>
        
        <h1 className="event-name mobile-only cat">Balearic London<span className="cat-day">Presents</span></h1>
