      ...
      <div id="bookingOptions">
        ...
        <div class="event-info">
            ...
            <div class="info artists">
              <h3><span>TENT <b>//</b> </span>DENNY KEM</h3>
       ...
       <div class="book-wrapper">
          ...
          <div class="button-wrapper new-button-wrapper">
            <Button classes="events-button new-events-button"  btnType="hollow">
              <a href="https://www.sevenrooms.com/reservations/littleportland?default_date=2025-05-08&default_time=21:00&default_party_size=4" target="_blank">
        ...
        <div class="button-wrapper new-button-wrapper">
            <Button classes="events-button ticketNew" btnType="hollow">
              <a href="https://sevn.ly/xfLaQpye" target="_blank">
                CLUB GUESTLIST ONLY
              </a>
            </Button>
        </div>
