      ...
      <div id="bookingOptions">
        ...
        <div class="event-info">
            ...
            <div class="info artists">
              <h3><span>TENT <b>//</b> </span>GABY D'ANNUNZIO, Harri Pepper</h3>
              <h3><span>STUDIO <b>//</b> </span>DUKE BROOKS, Grace Sands, LUKE SOLOMON</h3>
            </div>
        </div>
        <div class="book-wrapper">
          ...
          <div class="button-wrapper new-button-wrapper">
            <Button classes="events-button new-events-button"  btnType="hollow">
              <a href="https://www.sevenrooms.com/reservations/littleportland?default_date=2025-04-19&default_time=21:00&default_party_size=4" target="_blank">
