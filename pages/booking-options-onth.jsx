  ...
  return (
    <>
      ...
      <div id="bookingOptions">
        <h1 className="event-name desktop-only day-category"><span className="day">15 Year Anniversary</span> RAWAX</h1>
        
        <h1 className="event-name mobile-only cat"><span className="cat-day">15 Year Anniversary</span> RAWAX</h1>
