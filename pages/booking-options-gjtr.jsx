  ...
  return (
    ...
    <Head>
      ...
      <div id="bookingOptions">
        <h1 className="event-name desktop-only day-category disco-saturdays"><span className="day">Friday</span> Residents</h1>        
        <h1 className="event-name mobile-only cat"><span className="cat-day">Friday</span> Residents</h1>      

        <div className="event-info">
           <div class="info date">
              <h2><span>FRI</span>24 Jul</h2>
            </div>
            <div class="info artists">
              <h3><span>TENT <b>//</b> </span>CHÉ WAX, FREDERIKA</h3>
              <h3><span>STUDIO <b>//</b> </span>BAS IBELLINI, Ouissam, Saint Guel</h3>
            </div>
        </div>

        <div className="button-wrapper new-button-wrapper mobile-only">
          <Button classes="events-button ticketNew" btnType="hollow">
            <a href="https://sevn.ly/xZmc8c6G" target="_blank">
        ...
        <div className="book-wrapper">
         ...
         <div class="button-wrapper new-button-wrapper desktop-only">
            <Button classes="events-button new-events-button"  btnType="hollow">
              <a href="https://www.sevenrooms.com/reservations/littleportland?default_date=2026-07-24&default_time=21:00&default_party_size=4" target="_blank">
