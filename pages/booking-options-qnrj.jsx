  ...
  return (
    <>
      ...
      <div id="bookingOptions">
        <h1 class="event-name halucinate">ALIEN COM</h1>
        <div class="event-info">
            <div class="info date">
              <h2><span>THU</span>22 MAY</h2>
            </div>
       ...
       <div class="book-wrapper">
          ...
          <div class="button-wrapper new-button-wrapper">
            <Button classes="events-button new-events-button"  btnType="hollow">
              <a href="https://www.sevenrooms.com/reservations/littleportland?default_date=2025-05-22&default_time=21:00&default_party_size=4" target="_blank">
        ...
        <div class="button-wrapper new-button-wrapper">
            <Button classes="events-button ticketNew" btnType="hollow">
              <a href="https://sevn.ly/xSjT4IVn" target="_blank">
                CLUB GUESTLIST ONLY
              </a>
            </Button>
        </div>
