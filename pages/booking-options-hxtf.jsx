  ...
  return (
    <>
      ...
      <div id="bookingOptions">
        <h1 className="event-name desktop-only day-category">Balance<span className="day">Presents</span></h1>
        
        <h1 className="event-name mobile-only cat">Balance<span className="cat-day">Presents</span></h1>
        ...
        <div className="book-wrapper">
         ...
         <div class="button-wrapper new-button-wrapper desktop-only">
            <Button classes="events-button new-events-button"  btnType="hollow">
              <a href="https://www.sevenrooms.com/reservations/littleportland?default_date=2025-07-12&default_time=21:00&default_party_size=4" target="_blank">
        ...
        <div className="button-wrapper new-button-wrapper desktop-only">
          <Button classes="events-button ticketNew" btnType="hollow">
            <a href="https://sevn.ly/xA8mp7P6" target="_blank">
              CLUB ENTRY ONLY [10PM]
            </a>
          </Button>
        </div>
