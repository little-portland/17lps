    ...
    <>
      ...
      <CenterContainer>
        <IFrameContainerStyle className="bookings-iframe"
          ...
          style={style}
        />
       <h2>For bookings of 6 guests or more in The Tent or private dining options, please contact the restaurant directly at <a href="mailto:eat@little-portland.com">eat@little-portland.com</a></h2> 
