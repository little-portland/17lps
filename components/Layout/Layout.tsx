  ...
  return (
    <>
      ...
      >     
        ...
        <p className="override-footer links footer-link"><i>Visit <a target="_blank" href="www.little-portland.com/override">www.little-portland.com/override</a> to book.</i></p> 
        </div>}
