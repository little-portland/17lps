    ...
    <>
      ...
      >     
        ...
        <br/>  
          <p>9:00PM</p>
        <br/>  
        <p className="links"><a target="_blank" href="https://www.sevenrooms.com/reservations/littleportland?default_date=yyyy-mm-06&default_time=21:00&default_party_size=5">[BOOK]</a> <a href="https://www.little-portland.com/menu" target="_blank">[MENU]</a></p>
        </div>}
      </div>}
      </Modal>
      <Modal
